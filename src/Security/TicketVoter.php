...
namespace Webkul\Ronanbriot\CoreFrameworkBundle\Security;
...
class TicketVoter extends Voter
{
    ...
    protected function supports($attribute, $subject)
    {
        ...
        return $subject instanceof \Webkul\Ronanbriot\CoreFrameworkBundle\Entity\Ticket;
    }
    ...
    protected function voteOnAttribute($attribute, $ticket, TokenInterface $token)
    {
        ...
        if (!$user instanceof \Webkul\Ronanbriot\SupportBundle\Entity\User) {
            return false;
        }
