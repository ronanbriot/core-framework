...
/**
 * SupportGroup
 * @ORM\Entity(repositoryClass="Webkul\Ronanbriot\CoreFrameworkBundle\Repository\SupportGroupRepository")
...
class SupportGroup
{
     ...
     * Add admin
     *
     * @param \Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance $admin
     *
     * @return SupportGroup
     */
    public function addAdmin(\Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance $admin)
    {
        $this->admins[] = $admin;
     ...
     * @param \Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance $admin
     */
    public function removeAdmin(\Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance $admin)
    {
