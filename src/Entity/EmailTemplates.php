 ...
 * EmailTemplates
 * 
 * @ORM\Entity(repositoryClass="Webkul\Ronanbriot\CoreFrameworkBundle\Repository\EmailTemplatesRepository")
...
class EmailTemplates
{
     ...
     * @ORM\ManyToOne(targetEntity="Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance", inversedBy="userSavedReplies")
