 ...
 * 
 * @ORM\Entity(repositoryClass="Webkul\Ronanbriot\CoreFrameworkBundle\Repository\SavedRepliesRepository")
...
class SavedReplies
{
     ...
     * @return Savedreplies
     */
    public function setUser(\Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance $user = null)
    {
        $this->user = $user;
     ...
     * @return Savedreplies
     */
    public function addSupportGroup(\Webkul\Ronanbriot\CoreFrameworkBundle\Entity\SupportGroup $groups)
    {
        $this->groups[] = $groups;
     ...
     */
    public function removeSupportGroups(\Webkul\Ronanbriot\CoreFrameworkBundle\Entity\SupportGroup $groups)
    {
     ...
     * Add teams
     *
     * @param \Webkul\Ronanbriot\CoreFrameworkBundle\Entity\SupportTeam $teams
     * @return EmailTemplatesCompany
     */
    public function addSupportTeam(\Webkul\Ronanbriot\CoreFrameworkBundle\Entity\SupportTeam $teams)
    {
        $this->teams[] = $teams;
     ...
     * @param \Webkul\Ronanbriot\CoreFrameworkBundle\Entity\SupportTeam $teams
     */
    public function removeSupportTeam(\Webkul\Ronanbriot\CoreFrameworkBundle\Entity\SupportTeam $teams)
    {
