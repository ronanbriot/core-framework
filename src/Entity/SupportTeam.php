 ...
 * SupportTeam
 * 
 * @ORM\Entity(repositoryClass="Webkul\Ronanbriot\CoreFrameworkBundle\Repository\SupportTeamRepository")
...
class SupportTeam
{
     ...
     * Add lead
     *
     * @param \Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance $lead
     *
     * @return SupportTeam
     */
    public function addLead(\Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance $lead)
    {
        $this->leads[] = $lead;
     ...
     * @param \Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance $lead
     */
    public function removeLead(\Webkul\Ronanbriot\CoreFrameworkBundle\Entity\UserInstance $lead)
    {
